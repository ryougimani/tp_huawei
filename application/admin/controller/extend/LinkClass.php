 ...
 */
class LinkClass extends BasicAdmin {

	protected $table = 'LinkClass';
	...
	protected function _data_filter(&$data) {
		foreach ($data as &$val) {
			...
			$this->request->action() !== 'recycle' && $val['ids'] = join(',', ToolsService::getListSubId($data, $val['id']));
		}
		$this->request->action() !== 'recycle' && $data = ToolsService::listToTable($data);
	}
